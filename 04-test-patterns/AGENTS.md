...
> [.ai/skills/test-automation/](.ai/skills/test-automation/SKILL.md) and follow
...
[.ai/skills/test-automation/](.ai/skills/test-automation/SKILL.md); it is the
...
> [.ai/skills/code-standards/](.ai/skills/code-standards/SKILL.md) and follow it.
...
[.ai/skills/code-standards/](.ai/skills/code-standards/SKILL.md); it is the
